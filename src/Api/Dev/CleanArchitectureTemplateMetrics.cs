...
public class NorthiwndMetrics {
  public const string MeterName = "CleanArchitectureTemplate";
  ...
  public NorthiwndMetrics(IMeterFactory meterFactory) {
    ...
    _counter = meter.CreateCounter<long>("CleanArchitectureTemplate.request.count");
    _duration = meter.CreateHistogram<double>("CleanArchitectureTemplate.request.duration", "ms");
  }
